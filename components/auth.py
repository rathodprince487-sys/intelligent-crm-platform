...
def render_admin_panel(auth_manager, current_user):
    ...
    st.markdown("""
<div class="admin-header" style="display: flex; align-items: center; gap: 12px;">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="40" height="40" fill="none">
<!-- Shield outer shape -->
<path d="M32 4 L54 13 L54 32 Q54 48 32 60 Q10 48 10 32 L10 13 Z" fill="#1e2d45" />

<!-- Shield inner highlight (left side) -->
<path d="M32 4 L10 13 L10 32 Q10 48 32 60 L32 4Z" fill="#263d5e"/>

<!-- Orange/red gradient fill for lightning bolt area -->
<path d="M32 4 L54 13 L54 32 Q54 48 32 60 Q10 48 10 32 L10 13 Z" fill="url(#shieldGrad)" opacity="0.15"/>

<!-- Lightning bolt -->
<path d="M36 14 L24 34 L31 34 L28 50 L40 28 L33 28 Z" fill="#e8541a"/>
<!-- Lightning bolt highlight -->
<path d="M36 14 L30 26 L33 28 L40 28 L36 14Z" fill="#f07040" opacity="0.6"/>

<!-- Shield border -->
<path d="M32 4 L54 13 L54 32 Q54 48 32 60 Q10 48 10 32 L10 13 Z" stroke="#ffffff" stroke-width="1" opacity="0.15" fill="none"/>

<defs>
<linearGradient id="shieldGrad" x1="10" y1="4" x2="54" y2="60" gradientUnits="userSpaceOnUse">
<stop offset="0%" stop-color="#e8541a"/>
<stop offset="100%" stop-color="#1e2d45"/>
</linearGradient>
</defs>
</svg>
User Management
